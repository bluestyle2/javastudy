...
public class RegexMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("빈".equals("현빈"));
		System.out.println(".*빈.*".equals("현빈"));
		
		System.out.println(Pattern.matches("빈", "현빈"));
		System.out.println(Pattern.matches(".*빈.*", "현빈"));
		System.out.println(Pattern.matches(".*빈.*", "속빈강정"));
		System.out.println(Pattern.matches(".*빈.*", "빈티지"));
		...
		String [] ppArr = {"장", "장.","장*",".장",".장.",".*장","장.*",".*장.*",
				".*빈건",".*(빈건)",".*(빈)(건)",".*(빈|건)",".*빈|건",".*[빈건]",
				".*(장군|커피)",".*[장군|커피]",".*[장군커피]",
				"[0-9]","[0-9]*","\\d","\\d*",
				"[0-9a-zA-Z]","[0-9a-zA-Z]*","[0-9a-zA-Z@._]",
				"[0-9a-zA-Z]{3}","[0-9a-zA-Z]{2,6}","[0-9a-zA-Z]{4,}",
				"[0-9]{3}-[0-9]{3,4}-[0-9]{4}",//"[0-9a-zA-Z]{,5}",
				"[^0-9]*","[0-9^]*","^*","\\^*","^[0-9]*","[0-9^@]*",
				"[^^]*",
				};
